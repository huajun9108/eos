  ...
  <div class="TimeAndAreaContainer showchoose">
    <div class="chooseTime box">
      ...
      <div class="time">
        ...
        <DatePicker :type="timeFlag?date:datatime" size="small" v-model="startTime" :options="optionsStart" placement="bottom-end"
        placeholder="Select date" @on-change="startChange" @on-clear="this.clearCharts"></DatePicker>
      </div>
      <div class="time">
        <span>{{timeFlag?'结束时间':'选择时间点(下)'}}</span>
        <DatePicker :type="timeFlag?date:datatime" size="small" v-model="endTime" :options="optionsEnd" placement="bottom-end"
